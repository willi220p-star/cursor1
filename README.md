...
- Notes writing styles follow the fourteen-slot list: Deepali Font, Myfont Muskan, the Quantum Enterprises faces, PAW-HandFont, Indie Flower, and Children Handwritten. Indie Flower is built in. The other faces use a font file you are licensed to use, added on that style.
