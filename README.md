...
- Notes Copy can save a named message template (name and copy), pick it later, or remove it. Those templates are stored in Supabase for the signed-in operator.
