...
- Notes Copy lists message templates in a Name and Copy table. Add a row, pick it later, or remove it. Those templates are stored in Supabase for the signed-in operator.
