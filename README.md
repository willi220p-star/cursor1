...
- Notes Copy has a Name and Copy table for a new message template. Saved templates are chosen from Select below that table, and they are stored in Supabase for the signed-in operator.
