import { generateForegroundColorFrom } from "@/carousel/lib/theme-utils";
import themes, { Theme } from "@/carousel/lib/themes";
import { ColorSchema } from "@/carousel/lib/validation/theme-schema";
